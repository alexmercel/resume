...
**Backend Developer**
- Spearheaded transition from manual deployments to CI/CD pipeline, reducing turnaround time by 50% and streamlining Dev-QA handoffs.
- Developed and maintained custom CRM applications using Salesforce and APEX; delivered 30+ API services using MuleSoft.
- Recognized for exceptional performance with the Pinnacle TCI Award and Growth Catalyst Award.

## Schneider Electric | Bangalore, India
*July 2021 -- Aug 2021*

**Intern**
- Researched UPS efficiency, proposing improvements for battery longevity and analyzing energy consumption trends.
